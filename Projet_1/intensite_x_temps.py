...
plt.plot(x1, y1, label="intensité AT", linestyle='', marker='o', markersize=4, color="#800080")
plt.plot(x2, y2, label="intensité AC", linestyle='', marker='s', markersize=4, color="#007980")
plt.plot(x3, y3, label="intensité MEN", linestyle='', marker='^', markersize=4, color="#008000")
plt.plot(x4, y4, label="intensité MN", linestyle='', marker='d', markersize=4, color="#FFA500")
